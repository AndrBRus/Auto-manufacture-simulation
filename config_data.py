...
class config_data(object):
    # class constructor
    def __init__(self, p_manufacture_defect, resolve_manufacture_defect, time_to_resolve_manufacture_defect, p_detail_defect, days_of_production, change_time, time_interval, welding_time, coloring_time, conveyor_length, conveyor_speed, car_length, distance_cars):
        self.change_time = change_time # time of one change at produciton
        self.u_time_interval = time_interval
